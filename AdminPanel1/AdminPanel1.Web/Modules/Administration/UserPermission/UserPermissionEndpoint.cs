using MyRepository = AdminPanel1.Administration.Repositories.UserPermissionRepository;
using MyRow = AdminPanel1.Administration.UserPermissionRow;

namespace AdminPanel1.Administration.Endpoints;
